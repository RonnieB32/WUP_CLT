...
From this pattern all of the graphs are only going to have one peak, the mean is r' mean(my1000$k25)' the sd is 'sd(my1000$k25)'.
...
From this pattern all of the graphs are only going to have one peak, the mean is r' mean(my1000$k36)' the sd is 'sd(my1000$k36)'.
